...
UBI is the function that distributes coins to all users registered in the system.
Hence this is a 'Universal Basic Income'. It can only be applied after a  coinbase
function has run to create value in the bankers ownership. UBI must be run before
any paycoins transaction can be spent (other than by the banker). 
*/
...
// currency split into genesis, coinbase, ubi, paycoins.
// This is ubi. if there are enough coins in the coinbase,
// ubi distributes evenly amongst all known members.
func main() {
